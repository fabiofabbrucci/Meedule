set :application, "Meedule"
set :repository,  "git@github.com:fabiofabbrucci/Meedule.git"
set :scm,         :git
...
set :domain,     "meedule.abmundi.com"
set :user,       "abmundic"
set :scm_passphrase, ""
ssh_options[:port] = 22123
ssh_options[:forward_agent] = true
set :deploy_to, "/var/www/vhosts/meedule.abmundi.com/httpdocs/"
